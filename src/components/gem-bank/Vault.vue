<template>
  ...
  <div class="mb-10 flex justify-center">
    ...
    " class="button-style transition ease-in-out delay-150 bg-blue-500 hover:-translate-y-1 hover:scale-110 hover:bg-indigo-500 duration-300" @click="moveNFTsOnChain">
      Move NFT!
    </button>
    <slot />
  </div>
